...
# for the following 2 lines to work you need to install the gopigo3
# again, this is just an application and this project can be applied to any other robot
...
def robot_commands():
    ...
    # uncomment the following to actuate a GoPiGo3
    # actuate_robot(state, angle_degrees, angle_dir, joystick_pull_force)
...
def actuate_robot(state, angle_degrees, angle_dir, joystick_pull_force):

    determined_speed = MIN_SPEED + joystick_pull_force * (MAX_SPEED - MIN_SPEED) / MAX_FORCE
